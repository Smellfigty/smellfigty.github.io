      ...
      <section className="cs-section cs-hero">
        <div className="cs-wrap">
          <div className="cs-kicker">
            <Reveal><MonoLabel>Fallstudie · AxiomLens</MonoLabel></Reveal>
          ...
          <div className="ax-hero-grid">
            <Reveal className="ax-hero-text">
              <h1 className="cs-title">AxiomLens – <span className="accent">Cashflow-Analyse für kleine Unternehmen</span></h1>
              <p className="cs-sub">Zerstreute Daten zum umsetzbaren Überblick formen</p>
              <p className="cs-lead">
                Dieses selbst initiierte Konzept zeigt, wie ein SaaS-Dashboard kleinen und mittleren Unternehmen sowie
                Freiberuflern einen klaren Cashflow-Überblick verschafft und dank KI-gestützter Prognosen ermöglicht,
                rechtzeitig zu handeln – bevor Probleme überhaupt entstehen. Ich habe die datenintensive UI klar
                strukturiert, Kennzahlen auf einen Blick gemacht und User Flows so gestaltet, dass sie jederzeit ruhig
                und verlässlich wirken.
              </p>
            ...
            <Reveal className="ax-hero-media">
              <ZoomImg src={AIMG + "Axiom_Main.png"} alt="AxiomLens Cashflow-Dashboard – Hauptübersicht"
                caption="Das Haupt-Dashboard von AxiomLens bündelt zentrale Cashflow-Kennzahlen, Trends und Erkenntnisse." />
            </Reveal>
          </div>
        </div>
      </section>

...
const PF = "../assets/cs/";
const OLDIMG = "https://alexmedved.com/assets/images/";
const OLD = {
      ...
      <section className="cs-section cs-hero">
        <div className="cs-wrap">
          <div className="cs-kicker">
            <Reveal><MonoLabel>Fallstudie · 05 – Portfolio v1</MonoLabel></Reveal>
          </div>
  ...
  return (
    <div className="cs-view">
      <section className="cs-section cs-hero">
        <div className="cs-wrap">
          <div className="cs-kicker">
            <Reveal><MonoLabel>Fallstudie · 05 – Portfolio v2</MonoLabel></Reveal>
          </div>

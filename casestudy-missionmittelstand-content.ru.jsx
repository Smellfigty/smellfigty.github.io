        ...
        <div className="cs-wrap">
          ...
          <Reveal className="cs-meta">
            ...
            <div className="cs-meta-cell">
              ...
              <div className="cs-meta-v">Бриф от компании, самостоятельный проект</div>
            </div>
            <div className="cs-meta-cell">
              <div className="cs-meta-k">Ограничения</div>
              <div className="cs-meta-v">Существующий визуальный стиль Mission Mittelstand, мобильная версия обязательна, десктоп вторичен, без библиотек компонентов</div>
            </div>
          </Reveal>

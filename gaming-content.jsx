          ...
          <div className="cs-grid2" style={{ alignItems: "center" }}>
            <div>
              <div className="cs-kicker">
                <Reveal><MonoLabel>Case Study · B2B Mobile Gaming</MonoLabel></Reveal>
              ...
              <Reveal as="p" className="gm-nda-note">
                <span className="gm-nda">NDA</span> Under NDA, I can't show real in-work visuals – but there's enough here to follow my contributions, the process, and how I approach an open-ended design challenge.
              </Reveal>
            </div>
            <Reveal>
      ...
      <section className="cs-section gm-stats-sec">
        <div className="cs-wrap">
          ...
          <div className="gm-statband">
            ...
            <Stat to={20} label="TOV Pages" />
            <Stat to={3} label="Core flows ownership" />
          </div>
        </div>
      </section>

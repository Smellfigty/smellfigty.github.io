          ...
          <div className="cs-grid2" style={{ alignItems: "center" }}>
            <div>
              <div className="cs-kicker">
                <Reveal><MonoLabel>Кейс · 03 – B2B Mobile Gaming</MonoLabel></Reveal>
              ...
              <Reveal as="p" className="cs-cap gm-nda-note">
                По соображениям конфиденциальности я не могу показывать реальные рабочие материалы – но здесь
                достаточно, чтобы проследить мой вклад, процесс и то, как я подхожу к открытой дизайнерской задаче.
              </Reveal>
            </div>
            <Reveal>
      ...
      <section className="cs-section gm-stats-sec">
        <div className="cs-wrap">
          <Reveal className="cs-head">
            ...
            <span className="mono-sm" style={{ color: "var(--ink-faint)" }}>Что сдвинула работа</span>
          </Reveal>
          <div className="gm-statband">
            <Stat pre="~" to={4} suf=" мес" label="До MVP1 – запущен в срок" />
            <Stat to={3} label="Языка запуска · EN / DE / RU" />
            <Stat from={20} to={17} label="Страниц ToV → слайдов-шпаргалок" />
            <Stat text={<><span className="dim">дни</span><span className="arr">→</span><span className="accent">часы</span></>}
              label="Скорость локализации" />
          </div>
        </div>
      </section>
